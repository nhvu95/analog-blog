...
import {HeaderComponent, SearchBarComponent, TopicFilterComponent} from "@shared";
  ...
  webs = [
    {
      ...
      description: "This website is a place where I jot down my daily musings, share my ideas, and experiment with new concepts that capture my imagination. Additionally, I also use this platform to curate and share interesting tidbits from the vast expanse of the internet.",
      modified: "04/03/2023",
    ...
    },
    {
      ...
      techs: ["Angular12", "SpringBoot", "WebRTC", "ActiveMQ", "PostgresSQL", "TURN-Server"],
      name: "Files to Friends",
      description: "This website allows users to send files directly between two browsers using a Peer to Peer connection without the need to save the file on external servers post.ts Google Drive or OneDrive. Additionally, our website can function as a torrent browser, enabling a browser to share large files with anyone.",
      modified: "01/02/2023",
